...
class AlbumVersionEntity(
    ...
    @OneToMany(mappedBy = "albumVersion", cascade = [CascadeType.ALL], orphanRemoval = true)
    var tracks: MutableSet<AlbumVersionTrackEntity> = linkedSetOf()
    ...
    companion object {
        fun normalizeTitle(title: String): String = normalizeRequiredText(title, "Album version title")
    }
}
